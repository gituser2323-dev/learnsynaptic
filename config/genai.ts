/**
 * Single source of truth for the /genai landing page's third-party
...
export const GENAI_EMAILJS_PUBLIC_KEY =
  process.env.NEXT_PUBLIC_EMAILJS_PUBLIC_KEY!;
export const GENAI_EMAILJS_SERVICE_ID =
