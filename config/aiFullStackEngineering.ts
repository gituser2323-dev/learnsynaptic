/**
 * Single source of truth for the /ai-full-stack-engineering landing page's third-party
...
export const AI_FULLSTACK_EMAILJS_PUBLIC_KEY =
  process.env.NEXT_PUBLIC_EMAILJS_PUBLIC_KEY!;
export const AI_FULLSTACK_EMAILJS_SERVICE_ID =
