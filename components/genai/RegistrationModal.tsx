...
import { isValidIndianMobile, normalizeIndianMobile } from "@/lib/genai/validation";
import { sendGenaiRegistration } from "@/lib/genai/email";
...
export function RegistrationModal() {
   ...
   * sendGenaiRegistration() becomes a best-effort secondary
   * notification. */
  async function handleSubmit(e: React.FormEvent) {
    ...
    const result = await submit({
      lead: {
        ...
        source: "genai-masterclass-modal",
      },
      analyticsEvent: "CompleteRegistration",
      analyticsParams: { formName: "GenaiRegistration" },
      notify: () => sendGenaiRegistration({ whatsappNumber, fullName }),
    });
