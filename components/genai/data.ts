...
export const awarenessList: AwarenessItem[] = [
  {
    icon: Laptop,
    headline: "You can write code, but can you build with GenAI?",
    description: "Writing code and building AI-integrated products are different skills now.",
  },
  {
    icon: Code2,
    headline: "Confused about RAG, agents, fine-tuning?",
    description: "5,000+ students learned when to use which — in production, not theory.",
  },
  {
    icon: TrendingUp,
    headline: "Worried freshers ‘get AI’ better than you?",
    description: "Your 2 years of real work experience plus GenAI skills beats AI-fluency alone, going into 2027.",
  },
];
...
export const audiencesList: AudienceItem[] = [
  {
    ...
    headline: "Students",
    description:
      "Worried your degree alone won’t get you hired in 2027? Ship a real RAG or agent project instead of one more theory course.",
  ...
  },
  {
    ...
    description:
      "Use GenAI to automate operations, generate content faster, improve customer support, and scale your business with AI agents.",
  ...
  },
  {
    ...
    description:
      "Automate repetitive work, ship production GenAI features, and stay ahead in an AI-driven workplace with 0–2 years' experience.",
  ...
  },
  {
    ...
    description:
      "Curious about GenAI? Whether you're starting from scratch or exploring a new direction, build a real RAG or agent project through live mentorship.",
    outcome: "A clear place to start",
  },
];

export const problemsList = [
  { text: "Bookmarked prompt guides, never used" },
  { text: "Copied prompts, no understanding" },
  { text: "A different GenAI tool every month" },
  { text: "Zero products shipped" },
  { text: "Nothing for your portfolio" },
  { text: "No idea how production GenAI works" },
];

export const solutionsList = [
  { text: "Live, working code every session" },
  { text: "One real GenAI product, shipped" },
  { text: "Built around production patterns from day one" },
...
export const daysData: DayItem[] = [
  {
    ...
    label: "The Session",
    problem:
      "Generic AI doesn't know your business, your docs, or your data — which is exactly why most AI demos fall apart the moment they meet the real world, and exactly what separates AI users from AI engineers heading into 2027.",
    solution:
      "Build AI that actually knows your data live — understand why LLMs hallucinate, then fix it with embeddings, a vector database, and a real RAG pipeline that answers questions from your own documents.",
    tech: "Why LLMs Hallucinate, Embeddings, Vector Databases, RAG Pipeline, OpenAI API, AI Agents, Production Deployment",
    project: "A RAG-Powered AI Application",
  },
];
