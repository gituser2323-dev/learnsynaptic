        ...
        <div style={{ textAlign: "center", maxWidth: 720, margin: "0 auto 56px" }}>
          <FadeIn>
            ...
            >
              ...
              <br />
              <span style={{ color: "var(--ls-primary)" }}>vs GenAI-Ready Professionals</span>
            </h2>
          </FadeIn>
          <FadeIn delay={0.1}>
        ...
        <div className="aib-2col" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24, marginBottom: 64 }}>
          <FadeIn y={20}>
            ...
            >
              ...
              <p style={{ color: "var(--ink-600)", fontSize: 15, margin: "24px 0 0" }}>Prompts one model for everything.</p>
            </div>
          </FadeIn>
          ...
          <FadeIn y={20} delay={0.1}>
            ...
            >
              ...
              <p style={{ color: "var(--ink-black)", fontSize: 15, fontWeight: 600, margin: "22px 0 0" }}>
                Chooses the right architecture — RAG when the model needs your data, agents when it needs to act,
                fine-tuning when it needs your voice.
              </p>
            </div>
          </FadeIn>
        </div>
