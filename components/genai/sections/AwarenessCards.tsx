...
import { awarenessList } from "../data";
    ...
    <section style={{ background: "var(--white)", padding: "96px 6%" }}>
      <div style={{ maxWidth: 1120, margin: "0 auto" }}>
        <div style={{ textAlign: "center", maxWidth: 760, margin: "0 auto 64px" }}>
          ...
          >
            Do you feel unprepared for the AI era?
          </h2>
        </div>
        <div className="aib-3col" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 32 }}>
          {awarenessList.map((w) => {
            const Icon = w.icon;
            return (
              <div
                key={w.headline}
                className="aib-sf-card"
                style={{
              ...
              >
                ...
                >
                  <Image
                    src="/bootcamplogos/unidentified-broken-image-1.jpeg"
                    alt="Feature Icon"
                    width={28}
                    height={28}
