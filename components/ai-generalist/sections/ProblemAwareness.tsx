...
export function ProblemAwareness() {
  ...
  const activeContent = t.problem.workflows[active.id];
  ...
  return (
    <section style={{ background: "var(--white)", padding: "clamp(72px, 14vw, 112px) 6%" }}>
      <div style={{ maxWidth: 1080, margin: "0 auto" }}>
        <div style={{ textAlign: "center", maxWidth: 720, margin: "0 auto 56px" }}>
          <FadeIn>
            ...
            >
              {t.problem.headline1}
              <br />
              <span style={{ color: "var(--ls-primary)" }}>{t.problem.headline2}</span>
            </h2>
          </FadeIn>
          <FadeIn delay={0.1}>
        ...
        <div className="aig-2col" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24, marginBottom: 64 }}>
          <FadeIn y={20}>
            <div
            ...
            >
              ...
              <p style={{ color: "var(--ink-600)", fontSize: 15, margin: "24px 0 0" }}>{t.problem.mostCaption}</p>
            </div>
          </FadeIn>
          ...
          <FadeIn y={20} delay={0.1}>
            ...
            >
              ...
              >
                {t.problem.smartLabel}
              </div>
              <div
                className="aig-compare-logo-grid"
          ...
          >
            {active.steps.map((step, i) => (
              ...
              >
                ...
                <div style={{ fontSize: 12.5, color: "var(--ink-400)", marginTop: 4, lineHeight: 1.5 }}>
                  {activeContent.why[i]}
                </div>
              </motion.div>
            ))}
        ...
        <FadeIn>
          ...
          >
            ...
            >
              {t.problem.closingHeadline1} <br />
              {t.problem.closingHeadline2}
            </h3>
