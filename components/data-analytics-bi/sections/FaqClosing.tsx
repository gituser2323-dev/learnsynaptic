...
import { formatClosingDate } from "@/lib/data-analytics-bi/schedule";
    ...
    <>
      ...
      <section style={{ background: "var(--ls-dark)", color: "#fff", padding: "100px 6%", textAlign: "center" }}>
        ...
        <p style={{ color: "var(--ink-200)", fontSize: 17, margin: "0 0 32px" }}>
          2-Hour Data Analytics &amp; BI Masterclass — {formatClosingDate()}. Seats close when it&apos;s full.
        </p>
        ...
        <div style={{ marginTop: 44, color: "var(--ink-400)", fontSize: 14 }}>
          learnsynaptic.com · #DataAnalyticsBI2027
        </div>
      </section>
    </>
  );
