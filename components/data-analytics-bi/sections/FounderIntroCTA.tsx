    ...
    <>
      <section style={{ background: "var(--white)", padding: "0 6%" }}>
        <div style={{ maxWidth: 820, margin: "0 auto", textAlign: "center" }}>
          ...
          >
            The 2-Hour Data Analytics &amp; BI Masterclass
          </h2>
          <p style={{ color: "var(--ink-600)", fontSize: 16, lineHeight: 1.7, maxWidth: 560, margin: "0 auto 40px" }}>
            Not just how to read a spreadsheet — but how to build dashboards leadership actually trusts, live, the
            way real analysts work.
          </p>
          <div
            style={{
              position: "relative",
