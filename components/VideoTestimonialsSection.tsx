...
const testimonials: Testimonial[] = [
    { id: 't4', studentName: 'Priya Gaikwad', program: 'AI Engineering',     videoSrc: '/gallery/t4.mp4' ,posterSrc: '/gallery/t4-poster.png'},
  ...
  { id: 't3', studentName: 'Sanket K', program: 'GenAI Builder',    videoSrc: '/gallery/t3.mp4',posterSrc: '/gallery/t3-poster.png' },
<<<<<<< HEAD
    { id: 't4', studentName: 'Student Name', program: 'Data Science',     videoSrc: '' },
  { id: 't4', studentName: 'Student Name', program: 'Data Science',     videoSrc: '' },
=======
    { id: 't5', studentName: 'Student Name', program: 'Data Science',     videoSrc: '' },
  { id: 't6', studentName: 'Student Name', program: 'Data Science',     videoSrc: '' },
>>>>>>> c81ba5c (final)
