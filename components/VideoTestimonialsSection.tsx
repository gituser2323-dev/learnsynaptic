...
const testimonials: Testimonial[] = [
  { id: 't1', studentName: 'Sumit M',     program: 'AI Full Stack Dev — now SDE', videoSrc: '/gallery/t1.mp4', posterSrc: '/gallery/t1-poster.jpg' },
  { id: 't2', studentName: 'Akash P',     program: 'AI Full Stack Dev', videoSrc: '/gallery/t2.mp4', posterSrc: '/gallery/t2-poster.jpg' },
  { id: 't3', studentName: 'Student Name', program: 'GenAI Builder',    videoSrc: '' },
