      ...
      <div style={{ maxWidth: 1080, margin: "0 auto" }}>
        ...
        <div style={{ textAlign: "center", maxWidth: 720, margin: "0 auto 56px" }}>
          <FadeIn>
            ...
            >
              We Don&apos;t Teach AI Tools.
              <br />
              <span style={{ color: "var(--ls-primary)" }}>We Teach You To Solve Problems With AI.</span>
            </h2>
          </FadeIn>
          <FadeIn delay={0.1}>
        ...
        <div className="aib-2col" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24, marginBottom: 64 }}>
          <FadeIn y={20}>
            ...
            >
              ...
              <p style={{ color: "var(--ink-600)", fontSize: 15, margin: "24px 0 0" }}>Uses one AI for everything.</p>
            </div>
          </FadeIn>
          ...
          <FadeIn y={20} delay={0.1}>
            ...
            >
              ...
              <p style={{ color: "var(--ink-black)", fontSize: 15, fontWeight: 600, margin: "22px 0 0" }}>
                Chooses the best AI for every task.
              </p>
            </div>
          </FadeIn>
        </div>
