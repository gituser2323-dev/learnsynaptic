...
import { isValidIndianMobile, normalizeIndianMobile } from "@/lib/ai-full-stack-engineering/validation";
import { sendAiFullStackRegistration } from "@/lib/ai-full-stack-engineering/email";
...
export function RegistrationModal() {
   ...
   * sendAiFullStackRegistration() becomes a best-effort secondary
   * notification. */
  async function handleSubmit(e: React.FormEvent) {
    ...
    const result = await submit({
      lead: {
        ...
        source: "ai-full-stack-engineering-modal",
      },
      analyticsEvent: "CompleteRegistration",
      analyticsParams: { formName: "AiFullStackRegistration" },
      notify: () => sendAiFullStackRegistration({ whatsappNumber, fullName }),
    });
