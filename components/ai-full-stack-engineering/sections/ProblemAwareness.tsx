        ...
        <div style={{ textAlign: "center", maxWidth: 720, margin: "0 auto 56px" }}>
          <FadeIn>
            ...
            >
              Most CS Students
              <br />
              <span style={{ color: "var(--ls-primary)" }}>vs AI-First Engineers</span>
            </h2>
          </FadeIn>
          <FadeIn delay={0.1}>
        ...
        <div className="aib-2col" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24, marginBottom: 64 }}>
          <FadeIn y={20}>
            ...
            >
              ...
              <p style={{ color: "var(--ink-600)", fontSize: 15, margin: "24px 0 0" }}>Uses one framework for everything.</p>
            </div>
          </FadeIn>
          ...
          <FadeIn y={20} delay={0.1}>
            ...
            >
              ...
              <p style={{ color: "var(--ink-black)", fontSize: 15, fontWeight: 600, margin: "22px 0 0" }}>
                Chooses the right stack for the problem — React for UI, Node for APIs, AI models where they add
