...
import { formatBadgeDate } from "@/lib/ai-full-stack-engineering/schedule";
  ...
  return (
    <section style={{ background: "var(--ls-dark)", color: "#fff", padding: "72px 6% 96px", position: "relative", overflow: "hidden" }}>
      ...
      >
        ...
        >
          &nbsp;YOUR DEGREE WON&apos;T GET YOU HIRED IN 2027. YOUR PORTFOLIO WILL.
        </div>
        <h1
          className="aib-hero-item"
          style={{
        ...
        >
          Engineers Who Build The Future.
          <br />
          <span style={{ color: "var(--ls-primary-light)" }}>Not Just Code It.</span>
        </h1>
        <div className="aib-hero-item" style={{ gridArea: "subhead", marginTop: 22 }}>
          <p style={{ fontSize: 17, color: "var(--ink-200)", maxWidth: 520, margin: 0, lineHeight: 1.6 }}>
            Most CS students memorize DSA. Very few ship AI-integrated products. This free 2-hour live masterclass
            helps you become one of them.
          </p>
          <div style={{ fontSize: 13.5, fontWeight: 700, color: "var(--ls-primary-light)", marginTop: 14, letterSpacing: "0.02em" }}>
            Full Stack Development | AI Integration | Real Projects
          </div>
        </div>
        ...
        <div className="aib-cta-row aib-hero-item" style={{ gridArea: "buttons", marginTop: 34 }}>
          ...
          <a
            href={AI_FULLSTACK_WHATSAPP_COMMUNITY_URL}
            target="_blank"
