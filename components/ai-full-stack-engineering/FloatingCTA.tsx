...
import { formatFloatingDate } from "@/lib/ai-full-stack-engineering/schedule";
        ...
        >
          <div className="aib-floating-cta">
            <div className="aib-floating-cta-info">
              <span className="aib-floating-cta-title">2-Hour Full Stack Engineering Masterclass</span>
