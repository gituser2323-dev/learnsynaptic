...
export const awarenessList: AwarenessItem[] = [
  {
    icon: Laptop,
    headline: "You only know DSA?",
    description: "Companies don't hire for LeetCode anymore, they hire for what you've shipped.",
  },
  {
    icon: Code2,
    headline: "Confused which stack to learn — MERN, AI, or both?",
    description: "Join 5,000+ students who picked one path instead of guessing.",
  },
  {
    icon: TrendingUp,
    headline: "Still building todo apps for your resume?",
    description: "Recruiters are already filtering for AI-integrated projects for 2027 hiring cycles.",
  },
];
...
export const audiencesList: AudienceItem[] = [
  {
    ...
    headline: "Students",
    description:
      "Worried your degree alone won’t get you hired in 2027? Ship a real AI-integrated full stack app instead of one more theory course.",
  ...
  },
  {
    ...
    description:
      "Use AI-integrated tools to automate operations, ship features faster, and scale your business without hiring a full dev team.",
  ...
  },
  {
    ...
    description:
      "Automate repetitive work, build production-ready full stack + AI features, and stay ahead in an AI-driven workplace.",
  ...
  },
  {
    ...
    description:
      "Curious about engineering with AI? Whether you're starting from scratch or exploring a new direction, build a real full stack AI project through live mentorship.",
    outcome: "A clear place to start",
  },
];

export const problemsList = [
  { text: "Half-finished course videos" },
  { text: "Copy-pasted code, no understanding" },
  { text: "A different framework every month" },
  { text: "Zero deployed projects" },
  { text: "Nothing for your portfolio" },
  { text: "No idea how real teams ship" },
];

export const solutionsList = [
  { text: "Live, working code every session" },
  { text: "One real AI-integrated product, shipped" },
...
export const daysData: DayItem[] = [
  {
    ...
    label: "The Session",
    problem:
      "Todo apps and CRUD tutorials don't get you shortlisted anymore. Recruiters heading into 2027 are filtering for candidates who've actually wired AI into a real product — not just displayed data on a page.",
    solution:
      "Build a complete full stack application live — a React frontend, a Node/Express backend, a real database — then wire an AI feature directly into it, so it's not just CRUD, it's a product.",
    tech: "React, Node.js, Express, REST APIs, OpenAI API, AI Integration, Full Stack Deployment",
    project: "An AI-Integrated Full Stack App",
  },
];
