...
export const metadata: Metadata = {
  ...
  description:
    'Tell us where you want to be in 12 months. LearnSynaptic maps out the path — AI, Full Stack Dev, Data Science, and GenAI programs. Ahilyanagar-based · Pan-India intake.',
  openGraph: {
